        ...
        <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
          <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
            ...
            <ul className="nav nav-pills flex-column mb-auto">
              <li className="nav-item">
                <button className={`nav-link align-middle px-0 ${activeTab === "home" ? "text-primary" : ""}`}
                  onClick={() => setActiveTab("home")}>
                  <i className="fs-4 bi-house"></i>
                  <span className="ms-1 d-none d-sm-inline">Home</span>
                </button>
              ...
              <li className="nav-item">
                <button className={`nav-link align-middle px-0 ${activeTab === "products" ? "text-primary" : ""}`}
                  onClick={() => setActiveTab("products")}>
                  <i className="fs-4 bi-box"></i>
                  <span className="ms-1 d-none d-sm-inline">Products</span>
                </button>
              ...
              <li className="nav-item">
                <button className={`nav-link align-middle px-0 ${activeTab === "contacts" ? "text-primary" : ""}`}
                  onClick={() => setActiveTab("contacts")}>
                  <i className="fs-4 bi-telephone"></i>
                  <span className="ms-1 d-none d-sm-inline">Contacts</span>
                </button>
              ...
              <li className="nav-item">
                <button className={`nav-link align-middle px-0 ${activeTab === "services" ? "text-primary" : ""}`}
                  onClick={() => setActiveTab("services")}>
                  <i className="fs-4 bi-briefcase"></i>
                  <span className="ms-1 d-none d-sm-inline">Services</span>
                </button>
              ...
              <li className="nav-item">
                <button className={`nav-link align-middle px-0 ${activeTab === "prescriptions" ? "text-primary" : ""}`}
                  onClick={() => setActiveTab("prescriptions")}>
                  <i className="fs-4 bi-prescription"></i>
                  <span className="ms-1 d-none d-sm-inline">Prescriptions</span>
                </button>
              ...
              <li className="nav-item">
                <button className={`nav-link align-middle px-0 ${activeTab === "categories" ? "text-primary" : ""}`}
                  onClick={() => setActiveTab("categories")}>
                  <i className="fs-4 bi-tags"></i>
                  <span className="ms-1 d-none d-sm-inline">Categories</span>
                </button>
              ...
              <li className="nav-item">
                <button className={`nav-link align-middle px-0 ${activeTab === "transactions" ? "text-primary" : ""}`}
                  onClick={() => setActiveTab("transactions")}>
                  <i className="fs-4 bi-cash"></i>
                  <span className="ms-1 d-none d-sm-inline">Transactions</span>
                </button>
              ...
              <li className="nav-item">
                <button className={`nav-link align-middle px-0 ${activeTab === "ambulance" ? "text-primary" : ""}`}
                  onClick={() => setActiveTab("ambulance")}>
