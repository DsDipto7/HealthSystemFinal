//correct code but not pass orderdetails to paymenthomepage
...
//         try {
//             // First save the order with user details and get order ID
//             const orderResponse = await axios.post(
//                 'http://127.0.0.1:8000/api/order/place/',
//                 {
//                     ...formData,
//                     total_price: totalPrice, // Add total price from cart
//                 },
//                 {
//                     headers: {
...
//                 // Store order ID for payment reference
//                 const orderId = orderResponse.data.id;
                
//                 // Here you will integrate payment gateway
//                 // For now, let's navigate to a payment selection page
//                 setTimeout(() => {
//                     navigate('/payment', {
//                         state: {
//                             orderId: orderId,
